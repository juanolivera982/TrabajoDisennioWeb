var app={}
var futbolImgs = datos => {
    app.futbolImgs=datos;
}
var logoClub = datos => {
    app.logoClub=datos;
}
...
function cargarPortada(){
    var portadaHtml="";
    portadaHtml+="<img id='imagen' src='"+app.futbolImgs[0].imagen+"' alt='No se encontro la imagen' class='col-12'/>";
...
function cargarNoticia(){
    var deporte=noticia => noticia.tipo=="futbol";
...
function iniciar(){
    ...
    var imagenes=app.futbolImgs.map(imagen=>imagen.imagen);
    function cambiar()
    {
        img.style.opacity = 0;
