var app={}
var natacionImgs = datos => {
    app.natacionImgs=datos;
}
var logoClub = datos => {
    app.logoClub=datos;
}
...
function cargarPortada(){
    var portadaHtml="";
    portadaHtml+="<img id='imagen' src='"+app.natacionImgs[0].imagen+"' alt='No se encontro la imagen' class='col-12'/>";
...
function cargarNoticia(){
    var deporte=noticia => noticia.tipo=="natacion";
...
function iniciar(){
    ...
    var imagenes=app.natacionImgs.map(imagen=>imagen.imagen);
    function cambiar()
    {
        img.style.opacity = 0;
