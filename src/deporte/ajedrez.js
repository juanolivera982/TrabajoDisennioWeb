var app={}
var ajedrezImgs = datos => {
    app.ajedrezImgs=datos;
}
var logoClub=datos=>{
    app.logoClub=datos;
}
...
function cargarPortada(){
    var portadaHtml="";
    portadaHtml+="<img id='imagen' src='"+app.ajedrezImgs[0].imagen+"' alt='No se encontro la imagen' class='col-12'/>";
...
function cargarNoticia(){
    var deporte=noticia => noticia.tipo=="ajedrez";
...
function iniciar(){
    ...
    var imagenes=app.ajedrezImgs.map(imagen=>imagen.imagen);
    function cambiar()
    {
        img.style.opacity = 0;
