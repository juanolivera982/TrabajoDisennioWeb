var app={}
var hockeySobreCespedImgs = datos => {
    app.hockeySobreCespedImgs=datos;
}
var logoClub = datos => {
    app.logoClub=datos;
}
...
function cargarPortada(){
    var portadaHtml="";
    portadaHtml+="<img id='imagen' src='"+app.hockeySobreCespedImgs[0].imagen+"' alt='No se encontro la imagen' class='col-12'/>";
...
function iniciar(){
    ...
    var imagenes=app.hockeySobreCespedImgs.map(imagen=>imagen.imagen);
    function cambiar()
    {
        img.style.opacity = 0;
