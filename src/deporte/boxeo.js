...
function cargarPortada(){
    var portadaHtml="";
    portadaHtml+="<img id='imagen' src='"+app.boxeoImgs[0].imagen+"' alt='No se encontro la imagen' class='col-12'/>";
...
function cargarNoticia(){
    var deporte=noticia => noticia.tipo=="boxeo";
...
function iniciar(){
    ...
    var imagenes=app.boxeoImgs.map(imagen=>imagen.imagen);
    function cambiar()
    {
        img.style.opacity = 0;
