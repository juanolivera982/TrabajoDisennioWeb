...
function cargarPortada(){
    var portadaHtml="";
    portadaHtml+="<img id='imagen' src='"+app.voleyImgs[0].imagen+"' alt='No se encontro la imagen' class='col-12'/>";
...
function cargarNoticia(){
    var deporte=noticia => noticia.tipo=="voley";
...
function iniciar(){
    ...
    var imagenes=app.voleyImgs.map(imagen=>imagen.imagen);
    function cambiar()
    {
        img.style.opacity = 0;
